    ...
    >
      ...
      <header className="flex items-start gap-6" data-rf-section="basics">
        ...
        {(basics.email ||
          ...
          <div className="shrink-0 space-y-0.5 text-[0.9em]">
            {basics.email && (
            ...
            {location && (
              <ContactRow icon={<MapPinIcon />} color={BRAND.blue}>
                {location}
              </ContactRow>
            )}
            {basics.website && (
            ...
            {basics.nationality && (
              <ContactRow icon={<GlobeIcon />} color={BRAND.blue}>
                {basics.nationality}
              </ContactRow>
            )}
            {basics.residencePermit && (
              <ContactRow icon={<IdCardIcon />} color={BRAND.blue}>
                {basics.residencePermit}
              </ContactRow>
            )}
          </div>
