// Small inline SVG icons used by the dashboard. Each inherits color via
// `currentColor` and size via the `className` prop, so callers control styling
// with utility classes. Kept dependency-free (no icon library).
...
export function ActivityDot({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
